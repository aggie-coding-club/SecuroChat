...
const createConversation = async (
  ...
  try {
    ...
    await userConversationModel.addConversationParticipants(
      allParticipantID,
      conversationID
    );
...
const getConversationData = async (userID, conversationID) => {
  try {
    ...
    const conversationParticipants =
      await userConversationModel.getConversationParticipants(
        resultRow.conversation_id
      );
    ...
    const onlineConversationStatus =
